...
class SpectralEnhancer {
    ...
    var noPeaksArray: [Float] = [Float] (repeating: 0.0, count: AudioManager.binCount)      // intermediate array
    var sum         : [Float] = [Float] (repeating: 0.0, count: AudioManager.binCount)      // local sum vector
    var sumGap      : [Float] = [Float] (repeating: 0.0, count: AudioManager.binCount)      // local sum vector
    var sumCount    : [Int]   = [Int]   (repeating: 0,   count: AudioManager.binCount)      // count of values included in each local sum
    var sumGapCount : [Int]   = [Int]   (repeating: 0,   count: AudioManager.binCount)      // count of values included in each local sum
